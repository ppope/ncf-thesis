...
combine_results <- function(hist, count){
  ...
  combined.results <- data.frame( "Gene"= v, "Probe" = v, "SNP" = v, "Estimate" = w, "P.Value" = w, 
                                  "Prevalence" = w, "Test.Allele" = v, "ADC.or.SCC" = v)
...
write.csv(all.results, "/home/delores/Academic/LRRI2013/Phil/betareg/output/total_reg_results.csv", row.names=FALSE)

#2106 SNPs significant at 0.05 identified.
#1136 SCC
#970 ADC
